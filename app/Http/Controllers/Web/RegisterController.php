...
public function store(Request $request)
{
    ...
    if ($data['type'] == 2) {
        try {
            ...
            $smsText .= "Source: https://toptrustedfxbrokers.iqbrandx.com/public/\n";
    ...
    // إذا النوع 1 أو 2، أرسل QR بالإيميل
...
return redirect()->back()->with('success', 'thank you for submitting your sponsorship request.');
}
